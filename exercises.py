...
#
# Create a tuple named foods containing the same number of foods (strings) as there
...
#
# Create a dictionary named home_town containing the keys of city, state, and
# population.
...
def hometown_info():
    # your code here
    home_town = {'city': 'Boulder', 'state': 'Colorado', 'population': '105k'}
...
# Use a for loop to iterate over the key: value pairs in the home_town dictionary and
# append a string with the following format to home_town_items: "<key> = <value>"
